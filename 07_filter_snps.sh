...
input_vcf="/path/to/sole_WGS_pipeline/vcf/raw_snps.vcf.gz"
output_vcf="/path/to/sole_WGS_pipeline/vcf/snps_hardfiltered.vcf.gz"
...
nohup gatk VariantFiltration \
    ...
    --filter-name "Filter" \
    -O "${output_vcf}" > "/path/to/sole_WGS_pipeline/vcf/hardfilter.log" 2>&1 &
